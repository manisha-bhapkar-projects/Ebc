...
import { callOffersListApi } from "../../Action/OffersAction";
...
const OfferChart = (props) => {
  ...
  const options = {
    title: {
      display: true,
      text: "Offers Graph Representation",
    },
    scales: {
      yAxes: [
        {
...
export default connect(null, mapDispatchToProps)(OfferChart);
